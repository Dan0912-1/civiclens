    ...
    <main className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.section}>
          ...
          <p>
            GovDecoded changes that. We take real legislation, pull the bills most
        ...
        <div className={styles.section}>
          ...
          <div className={styles.neutralBox}>
            ...
            <p>
              GovDecoded is <strong>strictly nonpartisan</strong>. We never tell
        ...
        <div className={styles.section}>
          ...
          <p>
            GovDecoded was built by a high school student who serves on his town's
