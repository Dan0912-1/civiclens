      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <p className={styles.subhead}>
            CivicCipher pulls real bills moving through Congress right now and
      ...
      <section className={styles.how}>
        ...
        <div className={styles.steps}>
          {[
            ...
            { n: '02', title: 'We find the bills', body: 'CivicCipher pulls real legislation moving through Congress right now — filtered to what\'s relevant.' },
