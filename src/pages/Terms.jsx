    ...
    <main className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.section}>
          ...
          <p>
            By using GovDecoded, you agree to these Terms of Service. If you do
        ...
        <div className={styles.section}>
          <h2>What GovDecoded provides</h2>
          <p>
            GovDecoded is a nonpartisan civic education tool that displays
        ...
        <div className={styles.section}>
          ...
          <div className={styles.neutralBox}>
            ...
            <p>
              GovDecoded does not provide legal, political, or professional
        ...
        <div className={styles.section}>
          ...
          <p>
            You may use GovDecoded without an account. If you create one, you
        ...
        <div className={styles.section}>
          ...
          <p>
            You agree not to use GovDecoded to:
          </p>
        ...
        <div className={styles.section}>
          ...
          <p>
            ...
            non-commercial use only. The GovDecoded&#x2122; name, app design,
        ...
        <div className={styles.section}>
          ...
          <p>
            GovDecoded is provided "as is" without warranties of any kind. We
