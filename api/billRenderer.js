...
//
// Federal bills only — they live in the bills table keyed by congress_bill_id
// ("119-hr-2847"). Unknown bills (incl. state URLs) fall back to a valid generic
// page so a bot always gets clean meta instead of an empty shell.
